...
seed_points = GetPointListFromMPS('/home/skilpadd/Job/Coronary-Artery-Tracking-via-3D-CNN-Classification/data_process_tools/seed_points_mps/seedpoints_d_0.mps', image)
seed_points = [point[::-1] for point in seed_points]
...
def search_seeds_ostias(max_size=(200, 10)):
    ...
    # SavePointListAsMPS([point[::-1] for point in index], 'seeds_initial.mps', image)
        ...
        if left_x >= 0 and right_x < h and left_y >= 0 and right_y < w and left_z >= 0 and right_z < z:
            ...
            if count % batch_size == 0:
                ...
                for i in range(batch_size):
                    ...
                    res_seeds[center_coord_list[i]] = 0 if seeds_proximity[i] < 250 else seeds_proximity[i]
