...
def create_patch_images(path_name,spacing_path,gap_size):
    ...
    for dataset in datasets:
        ...
        csv_name = "./patch_data/ostia_patch/negative/" + 'gp_' + str(gap_size) + '/' + 'd' + str(ds_idx) + "_patch_info.csv"
        ...
        if error_count > 0:
            ...
            info_file_path: str = "./patch_data/ostia_patch/negative/" + 'gp_' + str(gap_size) + '/' + 'd' + '.txt'
