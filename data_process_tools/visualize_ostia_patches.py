...
root_ds = 'train_data'
save_dir = 'ostia_points_mps'
patch_dirs = 'patch_data/ostia_patch (copy)/postive/gp_1'
...
for ds_df in ds_dfs:
    ...
    for patch_name in patch_names:
        _, ds_idx, _, x, _, y, _, z = os.path.basename(patch_name).split('.')[0].split('_')
...
for ds_idx in ds_points:
    ...
    SavePointListAsMPS([[z / z_spacing, y / y_spacing, x / x_spacing] for x, y, z in ds_points[ds_idx]], os.path.join(save_dir, f'ostiapoints_d_{ds_idx}.mps'), image)
