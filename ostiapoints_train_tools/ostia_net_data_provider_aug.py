    ...
    def __init__(self,data_path, pre_fix_path, transform = None, flag = '', target_transform = None):
        ...
        if self.flag == 'train' or self.flag == 'val':
            ...
            for i in range(len(x_data)):
                print(f'ostia_net_data_provider_aug DataGenerater __init__ if: {i}')
            ...
            for i in range(len(x_data)):
                print(f'ostia_net_data_provider_aug DataGenerater __init__ else: {i}')
                if pre_fix_path is None:
        ...
        if self.flag == 'train':
            ...
            transforms = tio.Compose([
                tio.OneOf({
                    ...
                    tio.RandomElasticDeformation(num_control_points=(6, 6, 6), max_displacement=(2, 2, 2)): 0.4
                }, p=0.4),
